...
def encrypt_IDAT_chunks_after_decompressed(crit_chunks, e, n, iv):
    print("\nENCRYPT CBC:")
    ihdr_chunk = None
    ...
    for i in range(height):
        ...
        for block in blocks:
            ...
            c_int = RSA.encrypt(xored_block, e, n)
...
def decrypt_IDAT_chunks_after_decompressed(crit_chunks, tail, d, n, iv):
    print("\nDECRYPT CBC:")
    ihdr_chunk = None
    ...
    for i in range(height):
        ...
        while pos < len(full_encrypted):
            ...
            decrypted_int = RSA.decrypt(c_int, d, n)
